...
class User{
  User({this.firstName="", this.userId,this.lastName="", this.userName="", this.favoriteCount=0, this.reviewCount=0, this.avatar="002-dog.png"});
...
Future<User>getUser()async{
    ...
    if(isLoggedIn=="true"){
      ...
      final response = await http.get('https://gamebasebackend.azurewebsites.net/api/user',
      headers:<String,String>
...
Future<User>getUserById(String id)async{
   ...
   //   Map<String,String> headers = (token !=null)?{"Content-type": "application/json", "Accept": "application/json","Authorization":"Bearer "+token}:{"Content-type": "application/json", "Accept": "application/json"};
      final response = await http.get('https://gamebasebackend.azurewebsites.net/api/user/'+id,
      headers:<String,String>
